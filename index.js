...
// modify functions so from now on they return promises instead of calling callbacks
function getUser(id) {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      resolve({ name: "mostafa", id: id, githubAccount: "mostafa-meerzad" });
    }, 2000);
  });
